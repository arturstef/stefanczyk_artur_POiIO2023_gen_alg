...
63
normal! zo
let s:l = 73 - ((28 * winheight(0) + 21) / 42)
...
wincmd w
argglobal
if bufexists("Talgorithm.hpp") | buffer Talgorithm.hpp | else | edit Talgorithm.hpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("Tpopulation.cpp") | buffer Tpopulation.cpp | else | edit Tpopulation.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 47 - ((3 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
47
...
exe 'vert 3resize ' . ((&columns * 56 + 84) / 168)
tabnext 1
badd +1 Talgorithm.cpp
badd +1 Talgorithm.hpp
badd +0 Tpopulation.hpp
badd +0 Tpopulation.cpp
